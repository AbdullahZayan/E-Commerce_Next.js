        ...
        <div className="grid lg:grid-cols-[300px,1fr] gap-4">
          <div className="border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0">
            <div className="text-center flex flex-col items-center gap-1">
              ...
              <h2 className="text-gray-500 font-black text-[20px]">Abdullah Zayan</h2>
              <p className="inline-block py-2">CEO & Founder</p>
              <Image src="/quotes.svg" width={30} height={30} alt="quotes" />
              <p className="max-w-[200px] text-gray-500">
                Driven by a passion for innovation, Zayan is a skilled software
                engineer and web developer, crafting seamless digital
          ...
          <div className="bg-red-600 bg-[url(/cta-banner.jpg)] bg-cover h-[500px] rounded-2xl grid place-items-center">
            <div className="bg-[#ffffffab] min-w-[270px] sm:min-w-[300px] md:min-w-[500px] rounded-xl py-8 sm:px-8 px-2 grid place-items-center gap-3">
                ...
                <h2 className="font-extrabold text-2xl text-[#27272727]">Summer Collection</h2>
